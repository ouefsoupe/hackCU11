 ...
 */
export declare const convert12hTo24h: (abbr: AmPm, hour: number) => number;
/**
 ...
 */
export declare const getAmPm: (date: Date, locale: string) => AmPm;
/**
 ...
 */
export declare const formatTimePartials: (values: number[], locale: string, partial: "hour" | "minute" | "second") => FormattedPartial[];
/**
 ...
 */
export declare const getSelectedHour: (date: Date | null, locale: string, ampm?: "auto" | boolean) => number | string;
/**
 ...
 */
export declare const getSelectedMinutes: (date: Date | null) => number | string;
/**
 ...
 */
export declare const getSelectedSeconds: (date: Date | null) => number | string;
/**
